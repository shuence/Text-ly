...
class MainApp(QMainWindow):
    ...
    def create_menu_bar(self):
        ...
        # Window icon 
        self.setWindowIcon(QtGui.QIcon("/Text.ly.ico"))
        
        # set the title
        self.setWindowTitle("Text.Ly")
        ...
        # Bold-Italic menu **
        bold_menu = QMenu("Tools", self)
        menuBar.addMenu(bold_menu)

         # bold
        bold_action = QAction("Bold", self)
        bold_action.triggered.connect(self.bold_text)
        bold_menu.addAction(bold_action)

        # underline
        underline_action = QAction("Underline", self)
        underline_action.triggered.connect(self.underline_text)
        bold_menu.addAction(underline_action)

        # italic
        italic_action = QAction("Italic", self)
        italic_action.triggered.connect(self.italic_text)
        bold_menu.addAction(italic_action)

        # Alignment menu **
        align_menu = QMenu("Align", self)
        menuBar.addMenu(align_menu)


        # text alignment
        right_alignment_action = QAction("Align Right", self)
        right_alignment_action.triggered.connect(lambda : self.editor.setAlignment(Qt.AlignRight))
        align_menu.addAction(right_alignment_action)

        left_alignment_action = QAction("Align Left", self)
        left_alignment_action.triggered.connect(lambda : self.editor.setAlignment(Qt.AlignLeft))
        align_menu.addAction(left_alignment_action)

        justification_action = QAction("Center/Justify", self)
        justification_action.triggered.connect(lambda : self.editor.setAlignment(Qt.AlignCenter))
        align_menu.addAction(justification_action)
    ...
    def create_toolbar(self):
        ...
        self.font_size.valueChanged.connect(self.set_font_size)      # connect with funcूion
